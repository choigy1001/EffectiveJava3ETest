...
//                new Plant("로즈마리", LifeCycle.PERENNIAL)
        ...
        System.out.println("plantsByLifeCycleArr.length = " + plantsByLifeCycleArr.length);
        ...
        System.out.println("여기까지 37-1 코드 출력");
